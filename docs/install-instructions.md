...
The following modules are required for `PSRule.Rules.GitHub` to work:

- PSRule

The required version of each module will automatically be installed along-side `PSRule.Rules.GitHub` when using `Install-Module` or `Update-Module` cmdlets.
